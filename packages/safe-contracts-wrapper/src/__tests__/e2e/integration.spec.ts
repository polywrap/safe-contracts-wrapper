...
describe("ProxyFactory", () => {
    ...
    describe("proxies", () => {
        ...
        it("createProxy 1.2.0", async () => {
            ...
            expect(response.value).toEqual("0x0ddb56f661e5bd05fb252f5bc619f74039cd6d63");
        });
        ...
        it("createProxy 1.3.0", async () => {
            ...
            if (!response.ok) throw response.error;
            expect(response.value).not.toBeNull();
            expect(response.value).toEqual("0x1b721366fc1837d57b5d40a82c546e665545c6bc");
        });
        ...
        it("proxyCreationCode", async () => {
            ...
            if (!response.ok) throw response.error;
            expect(response.value).not.toBeNull();
            expect(response.value).toEqual("");
        });
        ...
        it("encode", async () => {
            ...
            if (!response.ok) throw response.error;
            expect(response.value).not.toBeNull();
            expect(response.value).toEqual("");
        });
